               ...
               <div class="logo-box">
                ...
                <div class="login__block__body">
                   <?php if (isset($_GET['login'])) {  ?>
                       <p><strong>incorrect email and/or password provided</strong><br />&nbsp;</p>
                   <?php } ?>
                   <form id="loginForm" method="post" action="page/login.php?m=<?php echo isset($_GET['m'])?$_GET['m']:''; ?>">
                    <div class="form-group">
                        <input name="username" type="text" class="form-control text-center" placeholder="Email Address">
                    </div>
                    ...
                    <div class="form-group">
                                        <div class="toggle-switch">
                                            <input name="rememberMe" type="checkbox" class="toggle-switch__checkbox" value="YES" checked="">
                                            <i class="toggle-switch__helper"></i>
                                        </div>
                                        <span class="switch-label">Remember Me</span>
                    </div>-->
                    <a href="#" onclick="$('#loginForm').submit();" class="btn btn-light btn-block btn--icon-text">Login <i class="zmdi zmdi-long-arrow-right"></i></a>
                   </form>
                </div>
            </div>
