...
<body><table border="0" cellspacing="0" cellpadding="5">
  ...
  <table align="center">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Flag:</td>
      <td>
	<label><input type="radio" name="flagged" value="1" <?php if ($row['flagged']==1) echo "checked=\"checked\""; ?> />YES</label>
	<label><input type="radio" name="flagged" value="0" <?php if ($row['flagged']==0) echo "checked=\"checked\""; ?> />NO</label>
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Comment:</td>
      <td><label>
        <input type="text" name="flagComment" value="<?php echo $row['flagComment']; ?>" />
      </label></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td><input type="submit" value="Set Flag" /></td>
    </tr>
  </table>
